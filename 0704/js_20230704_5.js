...
const add_multi = multiCalc(add, multiply, 1, true);
...
/*
  Closure :
    ...
    내부함수의 실행을 위해서 이 지역변수들을
    메모리에 보관해야함 : 이 메모리 영역을 Closure 라고함
*/
...
// 외부함수의 return 값(내부함수) 을 변수에 할당하지 않고
// 내부함수를 직접 호출함
console.log('outer()(40, 50) :', outer()(40, 50));

// 외부함수의 return 값(내부함수) 을 변수에 할당해서
// 내부함수를 호출함
let funct1 = outer();
funct1(40, 50)
